...
class Visitor
  ...
  def visit_const_a_node(const_a_node)              end
  def visit_var_decl_node(var_decl_node)            end
  def visit_identifier_list_node(ident_list_node)   end
  def visit_identifier_a_node(id_a_node)            end
  def visit_procedure_decl_node(proc_decl_node)     end
  def visit_procedure_a_node(proc_a_node)           end
  ...
  def visit_statement_a_node(state_a_node)          end
  def visit_condition_node(condition_node)          end
  def visit_expression_node(expression_node)        end
  def visit_expression_a_node(expression_a_node)    end
  def visit_term_node(term_node)                    end
  def visit_term_a_node(term_a_node)                end
  def visit_factor_node(factor_node)                end
  def visit_string_literal_node(str_literal_node)   end
